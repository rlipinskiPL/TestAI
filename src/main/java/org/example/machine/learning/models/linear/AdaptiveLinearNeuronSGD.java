...
public class AdaptiveLinearNeuronSGD extends StochasticGradientDescentModel {
    public AdaptiveLinearNeuronSGD(double learningRate, int epochs, int seed) {
        super(new LinearFunction(), new MeanSquaredError(), learningRate, epochs, seed);
    }

    public AdaptiveLinearNeuronSGD(double learningRate, int epochs) {
