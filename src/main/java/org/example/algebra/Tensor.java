...
import org.example.machine.learning.network.Shape;
...
//ToDo zabezpieczenia przed zlymi rozmiarami
//ToDo i w potomkach zabezpieczenia przed wyjsciami poza tablice
public abstract class Tensor implements Cloneable {
    ...
    public Tensor elementwise(Tensor tensor) {
        if (this.width != tensor.width() || this.height != tensor.height()) {
