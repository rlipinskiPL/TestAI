...
public class Vector extends Tensor {
    ...
    public Tensor multiply(double value) {
        return build(Arrays.stream(data).map(o -> value * o).toArray(), isHorizontal);
    }
    ...
    public Tensor power(double value) {
        return build(Arrays.stream(data).map(o -> java.lang.Math.pow(o, value)).toArray(), isHorizontal);
    }
    ...
    public Tensor cut(int start, int end) {
        ...
        return build(result, isHorizontal);
    }
    ...
    public java.lang.Object clone() {
        return build(data.clone(), isHorizontal);
    }
